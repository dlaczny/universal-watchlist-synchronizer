...
public class WatchlistItemDetailsTest {
    ...
    @Test
    public void isPlexOnly_whenLibraryMembershipIsPlexOnly_returnsTrue() {
        WatchlistItemDetails details = createDetails(
                List.of(),
                null,
                null,
        ...
        assertEquals(true, details.isPlexOnly());
    }
    ...
    private static WatchlistItemDetails createDetails(
            ...
            Double score,
            Integer voteCount) {
        return createDetails(genres, runtimeMinutes, language, score, voteCount, "watchlist");
    }
    ...
    private static WatchlistItemDetails createDetails(
        ...
        return new WatchlistItemDetails(
                ...
                "released", "available_on_plex", libraryMembership,
